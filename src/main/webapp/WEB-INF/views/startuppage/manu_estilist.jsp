...
<title>제조업체 견적 더보기</title>
</head>

<body>
	<h3 align = "center">제조업체 견적 현황 더보기</h3>
	<div class="container">
      <table class="table">
          <thead id="thead-c">
            <tr>        
 		...
 		<tbody>
 			<c:forEach var="manu_esti" items="${estilist}" >     
	      		...
	      		<td><a href= "${contextPath}/startuppage/manu_esti_updatestatus.do?e_status=${manu_esti.e_status}&m_name=${manu_esti.m_name}">수정하기</a></td>
	    	</tr>
  		</c:forEach>   
	</table>
</div>
            ...
            <div class="block-27">
              <ul>
              	<c:if test="${pagevo.startPage != 1}">
	                <li><a href="${contextPath}/startuppage/manu_estilist.do?nowPage=${pagevo.startPage-1}&cntPerPage=${pagevo.cntPerPage}">&lt;</a></li>
	            </c:if>
	            <c:forEach begin = "${pagevo.startPage}" end = "${pagevo.endPage}" var="idx">
	                ...
	                <c:when test="${idx!= pagevo.nowPage}">
	                <li><a href="${contextPath}/startuppage/manu_estilist.do?nowPage=${idx}&cntPerPage=${pagevo.cntPerPage}"> ${idx} </a></li>
	                </c:when>
	         <%--      
	                <li><a href="#">3</a></li>
	                <li><a href="#">4</a></li>
